...
You will receive a token in a separated mail for interacting with our testing AWS environment.
...
If you'll use pytest and write a basic test-suit in order to validate that your assigment is working as 
